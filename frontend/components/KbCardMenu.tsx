...
export default function KbCardMenu({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="pop max-h-[min(30rem,70vh)] overflow-y-auto absolute right-0 z-20 mt-1 w-60 origin-top-right rounded-lg border border-line bg-surface p-1.5 shadow-lift">
          {!confirming ? (
            <>
              <button
                type="button"
