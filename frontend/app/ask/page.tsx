    ...
    <div className="flex h-full flex-col">
      <div className="mb-4">
        ...
        <p className="mt-1 max-w-2xl text-sm text-slate-500">
          ...
          <span className="font-medium text-slate-600">Search in</span> to pick
          a specific group.
        </p>
      </div>

      {kbs && kbs.length === 0 ? (
        <div className="flex flex-1 flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 text-center">
          <Database size={26} className="mb-2 text-slate-300" />
